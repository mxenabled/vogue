 ...
 *
 * Based on: https://github.com/gradle/gradle/blob/master/subprojects/core/src/main/java/org/gradle/util/VersionNumber.java
 */
...
class VersionNumber private constructor(val major: Int, val minor: Int, val micro: Int, val patch: Int, val qualifier: String?, private val scheme: AbstractScheme) : Comparable<VersionNumber?> {
  ...
  companion object {
    ...
    fun version(major: Int): VersionNumber {
      return VersionNumber(major, 0, 0, 0, null, DEFAULT_SCHEME)
    }
